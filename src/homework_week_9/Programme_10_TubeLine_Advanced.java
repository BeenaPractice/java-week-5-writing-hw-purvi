    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (str.equalsIgnoreCase(c)) {
                ...
                System.out.println(" The lines passing through at" + str + "stations are:");
                System.out.println("-----------------------------------------------------");
            ...
            b = JOptionPane.showInputDialog(frame, "Do you want to tru again then please press Y", "Press Y or N", JOptionPane.WARNING_MESSAGE).toLowerCase();
        } while (b.equals("y"));
        System.exit(0);
    }
}
